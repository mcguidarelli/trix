...
#   ./build.sh --no-dwarf    Build without ELF/DWARF host introspection: the
#                            dwarf-open / peek-bytes / leb128-decode operators
#                            raise /unsupported and <sys/mman.h> is dropped, to
#                            trim binary size.  See src/build_config.inl
#                            (TRIX_NO_DWARF).
