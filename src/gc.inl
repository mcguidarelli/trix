...
//     Name (m_binding), Dict (entries), Set (entries; key only),
//     Array (Object[N]), Curry, Thunk, Tagged, Record,
//     Packed (a readonly Object array encoded as a byte stream --
//       walker decodes via make_packed_data's existing decoder and
//       emits one gc_mark_object call per referenced offset),
//     Coroutine, PipeBuffer, Mailbox, Monitor, BindingBucket,
//     BindingEntry, Supervisor.
//   Non-walkers (retired or reserved):
//     Other, Stream, Cell, Continuation, Screen.
//   Sentinel:
