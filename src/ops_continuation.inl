...
//
// Implements one-shot delimited continuations via two user-facing operators:
//
...
// body).  One-shot: m_exec_count is set to 0 after resume, preventing
// double invocation even through dup.

//===--- ContinuationContext ---===//
//
// Variable-length struct stored on the VM heap.  Header holds four
// length_t counts followed by the captured Objects.
//
// Layout of m_objects[]:
