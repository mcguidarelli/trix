...
//   This checks that the top operand is an Integer and the second is a
//   String (stack order: top is checked first).  On mismatch, a TypeCheck
...
//     VerifyNumber     -- any numeric type
//     VerifyString     -- String type only
//     VerifyArray      -- Array type only
//     VerifyProc       -- Array | Packed | Curry (executable procedure)
...
//                14 of 32 upper bits used; 18 remain for future flags.
