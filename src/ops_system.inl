...
//
// Time (clock, time, epoch-time, sleep), environment (getenv, setenv, getpid),
...
// debugger (debug, debug-hook, debug-describe -- see ops_debugger.inl),
// pseudo-random number generation (pcg-seed, pcg-uinteger, pcg-real, pcg-double),
// error handling internals (try-catch-handler, format-backtrace), and
