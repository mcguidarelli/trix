...
//     - Flavor: what was mutated (Object, DictHeader, DictEntry, SetEntry,
//       DictEntryNext, SetEntryNext, PackedName2/3/4, StreamInfixOffset)
...
//   - ExtValue mutations (tracked via save_level on the Object)
//
