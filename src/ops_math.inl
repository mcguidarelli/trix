...
//   rounding modes (fe-setround, fe-getround), NaN payloads, and the
...
//
// DIVISION BY ZERO
//   Integer division by zero raises Error::UndefinedResult.
//   Floating-point division by zero produces +/-Inf per IEEE 754
//   (no error raised).
//
// --- Categories ---
//
// Comparison:    eq, ne, lt, le, gt, ge, deep-eq, min, max, clamp
// Arithmetic:    add, sub, mul, div, idiv, mod, neg, abs, sign
// Rounding:      ceiling, floor, round, truncate
// Powers/logs:   sqrt, cbrt, exp, exp2, expm1, ln, log, log2, log10, log1p, pow, hypot
...
//                nan-with-payload, fe-setround, fe-getround, fe-raise,
//                fe-clear, fe-test, round-even, nearby-int
// Bitwise:       (see ops_bitwise.inl)
// Random:        random, random-range (PCG32, see pcg32.inl)
// Numeric pred:  is-number, is-integer, is-even, is-odd, is-zero,
//                is-positive, is-negative, number?, dot-product
//
