...
//   the interpreter loop.  The error() function (api.inl) handles error
//   processing: pushes error context to the error stack, looks up the
//   handler in handlersdict, and sets up recovery.  The interpreter loop
//   catch block resets m_scanner_stream and resumes.
//
