...
//     - If the alternative succeeds, @choice-barrier restores the save
//       point (undoing bindings) and returns the result.
...
//   @choice-barrier      Success handler: restore save, return result
