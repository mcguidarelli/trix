...
//
//   Watchers fire synchronously on `cell-set` for base cells, and on
//   `cell-get` for computed cells (after recomputation).  During a `batch`
//   block, watcher firing is deferred until the batch ends, allowing
//   multiple updates to coalesce.
//
// BATCHING
...
//
// CELL REPRESENTATION
//   Cells are a dedicated VM type (Type::Cell, slot 28).  The Object holds
...
//   output; unnamed cells show as --cell:value--.
//
// --- Operators ---
//
