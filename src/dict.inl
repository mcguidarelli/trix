...
//   ReadWriteFixed:    mutable, fixed capacity (userdict, errordict)
...
//   systemdict:   all 828 operators + system streams/variables (ReadOnly)
...
//   errordict:    error state: /error-name, /error-message, /error-data,
//                 /command, /ostack, /dstack, /estack (ReadOnly)
//   handlersdict: error handlers keyed by error name (ReadOnly)
...
public:
    ...
    Object copy_string_key_into_region(Trix *trx, Object key_obj, bool to_global) {
        ...
        if (to_global) {
            trx->gvm_set_obj_count(offset, static_cast<length_t>(length + 1));
        }
