...
//     keys).  Single multiplicative mixer (~5 cycles) with good avalanche;
//     variants from the "Fast splittable pseudorandom number generators"
//     family (Steele/Lea/Flood) and D. Lemire's refinements.
//
