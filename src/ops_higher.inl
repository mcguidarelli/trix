...
//   group-by           -- group into dict by key function
//
...
//   ro-array-from-mark   -- [ ... ] into read-only array
//   =array-from-mark     -- [ ... ] into =array
//   =string-from-mark    -- ( ... ) into =string
//   packed-from-mark     -- { ... } into packed array
//
...
//   try-result       -- extract value from /ok or re-throw /error
//   last-error       -- push the most recent error name
//   last-error-data  -- push the most recent error data
//   throw-with       -- throw with custom error data
//
// MODULES (namespace management)
//   module           -- begin a module definition (scoped dict)
//   use              -- import all names from a module into current dict
...
//   a new dict scope; definitions within it are local.  `use` and `import`
//   copy bindings into the caller's dictionary.
//
// MISCELLANEOUS
...
// ro-array-from-mark: mark any0 ... anyN :- arr
                    ...
                    for (integer_t i = 0; i < n; ++i) {
                        ...
                        if (!entry_name_obj.is_name()) {
                            ...
                            if (entry_value != nullptr) {
                                ...
                                current->put(trx, cloned_name, cloned_value, Dict::BindingMode::Bind);
                            } else {
