...
//
//     5b. TRY path: @try-barrier pushes the error name to the operand
//         stack (e.g., /type-check).  User code checks it.
//
...
//   run          str --                Execute file or string as code
...
//   @*-for            Typed for-loop continuations (7 numeric types)
