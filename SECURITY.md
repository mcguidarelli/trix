...
and tested against 283 automated test files (20,200+ assertions).
...
- Filesystem: `stream` (open), `with-stream`, `delete-file`, `rename-file`,
  ...
  `thaw`
- System: `run`, `system`, `shell`, `hostname`, `debug`
...
- libFuzzer harnesses exist for the scanner and interpreter (`fuzz/`).
