...
[`examples/zmachine.trx`](zmachine.trx) and the bundled story-file
catalog under [`examples/zmachine/`](zmachine/CATALOG.md).
...
Two well-known Z-Machine conformance test ROMs ship with this catalog:
...
- **The Interactive Fiction Database (IFDB)** -- catalog of every
  ...
  https://ifdb.org/
- **examples/zmachine/CATALOG.md** -- this implementation's bundled
  catalog of 46 playable story files plus the two compliance ROMs.
