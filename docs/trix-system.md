...
as a header-only C++23 library.  It provides 828 operators spanning eight
...
- **Operators** call native C++ functions (the 828 built-in operators).
...
language -- VM, scanner, interpreter, all 828 operators, all 31 types --
...
| Pattern matching | Native, deep, compiler-optimized  | Runtime, 5 operators                           |
...
files.  The full test suite is 18,300+ assertions across 246 files.  The
...
| Document            | Covers                                    |
| ------------------- | ----------------------------------------- |
| `trix-reference.md` | Complete operator reference (all 828 ops) |
