...
C++23.  Target compilers are GCC 15 and Clang 18.  Use modern
...
The SOLE exception in source is the middle-dot bullet (U+00B7) used
in `//===--- ... ---===//` file-header and section-banner art.
...
Multi-paragraph comment blocks are discouraged outside file headers.
